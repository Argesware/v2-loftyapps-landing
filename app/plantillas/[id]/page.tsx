      ...
      <main className="flex-1 pt-24">
        ...
        <section className="pt-4 pb-12 px-4 md:px-6">
          <div className="container mx-auto max-w-6xl">
            <div data-aos="zoom-in" className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                {template.category && (
        ...
        {suggestedTemplates.length > 0 && (
          <section className="py-20 px-4 md:px-6 bg-[#d1d9e0]">
            <div className="container mx-auto max-w-7xl">
              <h2 data-aos="zoom-in" className="text-3xl md:text-4xl font-black mb-12 text-center">Plantillas Similares</h2>
              <div data-aos="zoom-in" data-aos-delay="100" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-8">
                <TemplatesCard
        ...
        <section className="py-20 px-4 md:px-6">
          <div className="container mx-auto max-w-4xl">
            <div data-aos="zoom-in" className="neu-flat rounded-3xl p-12 md:p-16 text-center">
