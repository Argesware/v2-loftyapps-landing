      ...
      <main className="flex-1 pt-24">
        ...
        <section className="py-20 px-4 md:px-6 lg:px-12 2xl:px-32">
          <div>
            ...
            {/* Search Bar */}
            <div data-aos="zoom-in" data-aos-delay="100" className="max-w-2xl mx-auto mb-16">
            ...
            {/* Templates Grid */}
            {!loading && (
              <div data-aos="zoom-in" data-aos-delay="200" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-8">
                <TemplatesCard
            ...
            {!loading && filteredTemplates.length === 0 && (
              <div data-aos="zoom-in" data-aos-delay="200" className="text-center py-20">
